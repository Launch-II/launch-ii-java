...
public class MissileType extends LaunchType
{
    ...
    private int cMissileCost;
    private byte cRangeIndex;
    private byte cBlastRadiusIndex;
    private byte cMaxDamageIndex;
    
    public MissileType(byte cID, boolean bPurchasable, String strName, int lAssetID, boolean bNuclear, boolean bTracking, boolean bECM, byte cSpeedIndex, int cMissileCost, byte cRangeIndex, byte cBlastRadiusIndex, byte cMaxDamageIndex)
    {
        ...
        this.cMissileCost = cMissileCost;
    ...
    public int GetMissileCost() { return cMissileCost; }
