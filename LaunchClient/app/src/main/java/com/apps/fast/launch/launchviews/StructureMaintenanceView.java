...
public class StructureMaintenanceView extends LaunchView implements LaunchUICommon.StructureOnOffInfoProvider
{
    ...
    protected void Setup()
    {
        ...
        {
            if(((MissileSite)iconControlStructure).CanTakeNukes())
            {
    ...
    public void Update()
    {
        if(structureShadow != null)
        {
            ...
            if (structure != null)
            {
                ...
                //int OfflineUpkeepCost = (int) 0.1 * game.GetConfig().GetMaintenanceCost(structure); //In keeping with 10% ofline cost from LaunchGame. -Corbin
